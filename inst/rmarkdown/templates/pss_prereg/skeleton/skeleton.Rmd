...
<!-- This is the template that can be used for pre-registrating your study. This template was used so that it can 
...
<!-- Is it a primary study (where data are collected) or a study where secondary analyses are performed in an arhival data set? -->
...
## Participants
<!-- How many participants will be rectruited? Is there a power analysis performed? -->
...
<!-- What is the threeshold for confirming each one of the research hypothesis? -->

`r params$confirming_theershold_par`

## Disconfirming hypotheses threehold
<!-- What is the threeshold for dis-confirming each one of the research hypothesis? -->
